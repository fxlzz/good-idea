import { Modal, Typography, Radio, Segmented, InputNumber, Switch, Tag, Space, Input, Button } from 'antd'
...
export default function SettingsModal({ open, onClose }: SettingsModalProps) {
  ...
  const [activeSection, setActiveSection] = useState<'theme' | 'llm' | 'embedding' | 'storage' | 'chunking'>('theme')
          ...
          <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                background: activeSection === 'embedding' ? 'var(--ide-tab-active-bg)' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                background: activeSection === 'storage' ? 'var(--ide-tab-active-bg)' : 'transparent',
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                background: activeSection === 'chunking' ? 'var(--ide-tab-active-bg)' : 'transparent',
                ...
                <div>
                  ...
                  <div style={{ marginTop: 8 }}>
                    <InputNumber
                      ...
                      addonAfter="字符"
                      onChange={(value) =>
                        syncAndUpdate({ chunkSize: Number(value ?? 512) })
                      }
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div style={{ marginTop: 8 }}>
                    <InputNumber
                      ...
                      addonAfter="字符"
                      onChange={(value) =>
                        syncAndUpdate({ chunkOverlap: Number(value ?? 100) })
                      }
                    />
                  </div>
                </div>
