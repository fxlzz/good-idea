...
export default function HeaderBar({ onToggleAI, aiOpen }: HeaderBarProps) {
  ...
  const userMenuItems: MenuProps["items"] = [
    ...
    {
      key: "status",
      label: apiHealthy === true ? "后端在线" : apiHealthy === false ? "后端离线" : "检查中…",
      disabled: true,
    },
    { type: "divider" },
    {
  ...
  return (
    ...
    >
      ...
      >
        <span
          style={{
            ...
            height: 28,
            borderRadius: "10px",
            background: "linear-gradient(135deg, #6366f1 10%, #8b5cf6 80%)",
            color: "#fff",
            cursor: "default",
          }}
          aria-hidden
      ...
      <Space size="middle" style={{ paddingLeft: 12, minWidth: 0 }}>
        ...
        <Dropdown menu={{ items: bookmarkMenuItems }} placement="bottomLeft" trigger={["hover"]}>
          <Tooltip>
            <span
              style={{ cursor: "pointer", display: "flex", alignItems: "center" }}
              role="button"
      ...
      <Space size="middle" style={{ marginLeft: "auto" }}>
        ...
        <Tooltip
          title={apiHealthy === true ? "后端在线" : apiHealthy === false ? "后端离线" : "检查中…"}
        >
          <span
            style={{
              width: 8,
              ...
              borderRadius: "50%",
              background:
                apiHealthy === true ? "#52c41a" : apiHealthy === false ? "#8c8c8c" : "transparent",
        ...
        >
          <Space style={{ cursor: "pointer", color: "var(--ide-text)", alignItems: "center" }}>
            <Avatar size="small" style={{ background: "var(--ide-accent)", flexShrink: 0 }}>
              {firstLetter}
            </Avatar>
